#!/usr/bin/env python3
"""Plot vLLM Llama 3.1 8B: solo vs TP=2 4-HCA RDMA.

Same shape as bench/workload/qwen3-0p6b/plot.py — just retitled for
the bigger model.
"""
...
def plot_tps(rows: list[dict]) -> None:
    ...
    ax.set_title(
        "vLLM Llama 3.1 8B (concurrency=256, 256-tok output) — solo vs TP=2 4-HCA RDMA",
        fontsize=10,
    )
    fig.tight_layout()
